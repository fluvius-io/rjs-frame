    ...
    return (
      <div className="rjs-panel pb-4">
        ...
        <div className="rjs-panel-section">
          <div
            className="rounded-xl shadow-md border border-gray-200 px-6 py-4 relative"
            style={{
          ...
          >
            <div className="flex flex-col gap-1">
              ...
              <div className="flex justify-between items-center">
                ...
                <span className="text-green-500 text-sm font-semibold">1,000 (10%)</span>
              </div>
              <div className="pt-2">
                <span className="italic text-gray-400 text-sm">*Unit: million vnd (M)</span>
              </div>
            </div>
          </div>
        </div>
