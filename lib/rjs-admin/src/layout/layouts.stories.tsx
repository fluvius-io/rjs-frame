...
const TwoColumnLayoutDemo = ({ sidebarWidth = 'md' }: { sidebarWidth?: 'sm' | 'md' | 'lg' }) => {
  ...
  return (
    <div className="min-h-screen bg-background">
      ...
      <div className="flex flex-1">
        <aside className={`sticky top-16 h-[calc(100vh-4rem)] border-r bg-muted/10 ${sidebarWidthClasses[sidebarWidth]}`}>
          <div className="p-4">
            <DemoSidebar />
          </div>
        </aside>
...
const ThreeColumnLayoutDemo = ({ 
  ...
  return (
    <div className="min-h-screen bg-background">
      ...
      <div className="flex flex-1">
        <aside className={`sticky top-16 h-[calc(100vh-4rem)] border-r bg-muted/10 ${widthClasses[sidebarWidth]}`}>
          <div className="p-4">
            <DemoSidebar />
          </div>
        </aside>
        ...
        <aside className={`sticky top-16 h-[calc(100vh-4rem)] border-l bg-muted/10 ${widthClasses[rightPanelWidth]}`}>
          <div className="p-4">
            <DemoRightPanel />
          </div>
        </aside>
...
export const ThreeColumnCustomWidths: Story = {
  render: () => <ThreeColumnLayoutDemo sidebarWidth="lg" rightPanelWidth="md" />,
}; 