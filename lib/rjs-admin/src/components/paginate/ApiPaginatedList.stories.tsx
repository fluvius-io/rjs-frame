...
const meta: Meta<typeof ApiPaginatedList> = {
  title: 'Components/ApiPaginatedList',
  component: ApiPaginatedList,
  parameters: {
    layout: 'padded',
    docs: {
      description: {
        component: 'A PaginatedList component that fetches metadata and data from real API endpoints via Vite proxy.',
      },
    },
  },
  tags: ['autodocs'],
...
export const WithApiMetadata: Story = {
  render: () => {
    return (
      <div>
        <div className="mb-4 p-3 bg-blue-50 border border-blue-200 rounded text-sm">
          <strong>🔄 Hybrid Mode:</strong> Metadata from real API, sample data fallback (no dataUrl provided).
...
// Example using PaginatedList directly with API metadata
