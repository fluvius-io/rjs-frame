...
const meta: Meta<typeof Card> = {
  ...
  parameters: {
    ...
    docs: {
      description: {
        component:
          "A flexible card component with header, content, and footer sections. Built with Tailwind CSS and supports all standard HTML div attributes.",
      },
    },
  },
  tags: ["autodocs"],
...
export const NotificationCard: Story = {
  render: () => (
    <Card className="w-[400px]">
      ...
      <CardContent>
        <p className="text-sm">
          Your system has been successfully updated to version 2.1.0. New
          features include improved performance and bug fixes.
        </p>
      </CardContent>
      <CardFooter>
  ...
  render: () => (
    <Card className="w-[400px]">
      ...
      <CardContent>
        ...
        <p className="text-sm">
          Learn the fundamentals of React and how to build your first
      ...
      <div>
        ...
        <div className="space-y-4">
          ...
          <Card className="w-[500px]">
            ...
            <CardContent>
              <p>
                This card has more room for detailed content and longer
                descriptions.
              </p>
            </CardContent>
          </Card>
